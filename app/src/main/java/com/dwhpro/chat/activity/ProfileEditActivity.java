...
import com.dwhpro.chat.adapter.GalleryAdapter;
import com.dwhpro.chat.dialog.GenderSelectDialog;
import com.dwhpro.chat.dialog.InterestedInSelectDialog;
...
import com.dwhpro.chat.adapter.ItemAdapter;
import com.dwhpro.chat.dialog.RelationshipStatusSelectDialog;
import com.dwhpro.chat.dialog.YouLookingSelectDialog;
    ...
    public void getYouLike(int mLike) {
        ...
        switch (mLike) {
            ...
            case 1: {
                ...
                etInterestedIn.setText(getString(R.string.you_like_1));
                if (profileRef != null) {
                    profileRef.child("interestedIn").setValue(getString(R.string.you_like_1));
                };
                }
                break;
            ...
            case 2: {
                ...
                etInterestedIn.setText(getString(R.string.you_like_2));
                if (profileRef != null) {
                    profileRef.child("interestedIn").setValue(getString(R.string.you_like_2));
                };
                }
                break;
