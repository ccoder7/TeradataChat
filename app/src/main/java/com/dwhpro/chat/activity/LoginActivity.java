...
import com.dwhpro.chat.onboarding.PaperOnboardingPage;
...
import com.dwhpro.chat.dialog.LoginBottomSheetDialog;
import com.dwhpro.chat.onboarding.PaperOnboardingEngine;
import com.dwhpro.chat.onboarding.listeners.PaperOnboardingOnChangeListener;
import com.dwhpro.chat.onboarding.listeners.PaperOnboardingOnRightOutListener;
...
//                Toast.makeText(getApplicationContext(), "Swiped out right", Toast.LENGTH_SHORT).show();
    ...
    private ArrayList<PaperOnboardingPage> getDataForOnboarding() {
        // prepare data
        PaperOnboardingPage scr1 = new PaperOnboardingPage("Teradata Chat", "Become a Teradata Expert",
                Color.parseColor("#678FB4"), R.drawable.ic_ob_discover, R.drawable.onboarding_pager_circle_icon);
        PaperOnboardingPage scr2 = new PaperOnboardingPage("Chat", "Talk to Teradata Experts around the world.",
                Color.parseColor("#65B0B4"), R.drawable.ic_ob_chat, R.drawable.onboarding_pager_circle_icon);
        PaperOnboardingPage scr3 = new PaperOnboardingPage("Meet", "Meet other people working with Teradata",
    ...
    public void emailClicked(View view) {
        FynderApplication.getInstance().sendActionevent(Constants.CT_EMAIL);
        //LoginManager.getInstance().logInWithReadPermissions(this, Arrays.asList("public_profile", "email", "user_friends"));
        //showProgress(getString(R.string.login_progress_facebook));
    }
